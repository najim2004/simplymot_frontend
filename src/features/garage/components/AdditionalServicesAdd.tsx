...
import { setAdditionals } from "@/features/garage";
import { useAppDispatch, useAppSelector } from "@/store/hooks";
import { useDeleteServiceMutation, useGetPricingQuery } from '@/features/garage'
...
export default function AdditionalServicesAdd() {
    ...
    }, [formVersion, reset, additionals.length, additionals])
