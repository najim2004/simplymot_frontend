...
export default function Availability() {
  ...
  const generateWeekData = useCallback((weekIndex: number, month: number, year: number) => {
  ...
  }, [currentWeekIndex, selectedMonth, selectedYear, availabilityData, isInitialized, generateWeekData])
